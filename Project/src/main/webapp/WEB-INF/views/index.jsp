        ...
        <body>
                ...
                <div class="header-container">
                    ...
                    <div class="block-menu">
                        <select class="navegation_resp" onchange="location.hash = this.options[this.selectedIndex].value;">
                            <a href="${pageContext.request.contextPath}/map">Plattegrond</a>
                    ...
                    <div class="menu-select">
                        <nav>
                            <ol class="contentMenu">
                                <li>
                                    <a href="${pageContext.request.contextPath}/map"><div class="menubtn homebtn">
            ...
            <div id="banner" class="parallax"><div id="intro" class="banner-background"></div>
                <div class="infobanner">
                    <div class="welcome">EWA-5</div>
                    <div class="textbanner">
                        Voor de gemeente Amsterdam maken we in samenwerking met Eagle Eye een nieuw systeem om de wachtrijen te beperken.
                        Dit is in opdracht van de Hogeschool van Amsterdam voor het project Enterprise Web Applications.
                        <div class="bannerfoot"></div>
                    </div>
                </div>
            </div>
            <!-- end banner -->
