...
public class JsonLineInsert {
    ...
    public boolean insertData(ArrayList<PersonObject> list) throws SQLException {
    ...
    public boolean insertData(ArrayList<PersonObject> list, String sqlStatement) throws SQLException {
